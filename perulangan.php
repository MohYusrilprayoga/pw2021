...
<html lang="en">
  ...
  <div class="container input">
    <div class="mb-3">
      <input type="text" class="form-control" id="ControlInput1" name="faktor">
      <br>
    </div>
  </div>
  <div class="container button">
    <center><button type="submit" class="btn btn-outline-success" name="submit">Submit</button></center>
  </div>
  </form>
